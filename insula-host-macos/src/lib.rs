...
pub use error::Error;
pub use install::{
    install, install_with_mode, launch_installed, launch_installed_all,
    launch_installed_full, launch_installed_v2, launch_installed_v3,
    launch_installed_v4, launch_installed_with_log, InstallMode, InstalledApp,
};
